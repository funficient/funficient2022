...
var deck = [
    ...
    new card('Artist', 'artist'),
    new card('Snake', 'snake'),
    new card('Christmas', 'christmas') 


/*
    new card('Cancer', 'toast'),    new card('Tool', 'toast'),       
    new card('Rag', 'toast'),      new card('Thumbtack', 'toast'),        new card('Jell-O', 'toast'),    new card('Pot', 'toast'),       new card('Hoe', 'toast'),    
    ...
    new card('Camel', 'toast'),    new card('Leaf', 'toast'),    new card('Lunch', 'toast'),     new card('Pilot', 'toast'),       new card('Caviar', 'toast'),
    ...
    new card('Psychology', 'toast'),    new card('Parent', 'toast'),
    new card('Blueprint', 'toast'),    new card('Forest', 'toast'),    new card('Wigwam', 'toast'),    new card('Iceberg', 'toast'),
    new card('Snail', 'toast'),    new card('Jungle', 'toast'),
    new card('Syrup', 'toast'),    new card('Parachute', 'toast'),
    new card('Pudding', 'toast'),    new card('Parsley', 'toast'),
    new card('Sidewalk', 'toast'),    new card('Vodka', 'toast'),
    new card('Suicide', 'toast'),
   new card('Maid', 'toast'),    
    new card('Noose', 'toast'),
    new card('Comb', 'toast'),
    new card('Picture', 'toast'),
    new card('Frame', 'toast'),    new card('Jeep', 'toast'),
    ...
    new card('Remote control', 'toast'),    new card('Boxing glove', 'toast'),
    new card('Jeans', 'toast'),    
    new card('Aerial', 'toast'),
    new card('Crayons', 'toast'),
    new card('Pipe cleaner', 'toast'),    new card('Ribbon', 'toast'),
    new card('Pencil sharpener', 'toast'),    new card('Battery', 'toast'),
    new card('Wheel', 'toast'),    new card('Baton', 'toast'),
    new card('Orchestra', 'toast'),    new card('Suspenders', 'toast'),
    new card('Brassiere', 'toast'),    new card('Tractor', 'toast'),
    new card('Candlestick', 'toast'),    new card('Newspaper', 'toast'),
    new card('Secretary', 'toast'),    new card('Salesman', 'toast'),
    new card('Wallpaper', 'toast'),    new card('Tower', 'toast'),
    new card('Kitchen', 'toast'),    new card('Magnifier', 'toast'),
    new card('Garden', 'toast'),    new card('General', 'toast'),
